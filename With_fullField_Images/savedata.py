...
class SaveData:
    ...
    def save(self, sess, fnn_model, W_T, b_T, W_B1, b_B1, W_B2, b_B2, Xmin, Xmax, f1_ph, f2_ph, u_ph, x_ph, data, num_test, num_noisy, save_results_to):
        ...
        scipy.io.savemat(save_results_to+'R4_CNN_pred_DeepONet.mat', 
